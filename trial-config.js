window.TRIAL_CONFIG = {
    ...
    /* ==========================================================
       TRIAL LIST  (SET 1 — trials 1-24)
       ----------------------------------------------------------
       Fields per trial:
         trial_num  – unique trial identifier
         f1         – left flanker image filename  (key into `images`)
         cp         – center picture filename       (key into `images`)
    ...
    practiceTrials: [
        { trial_num: "p1", f1: "None.jpg", cp: "2377_neut.jpg", f2: "None.jpg", ft: "none" },
        { trial_num: "p2", f1: "2394_neut.JPG", cp: "2191_neut.JPG", f2: "2394_neut.JPG", ft: "neu" },
        { trial_num: "p3", f1: "2700_neg.JPG", cp: "2595_neut.JPG", f2: "2700_neg.JPG", ft: "neg" },
        { trial_num: "p4", f1: "None.jpg", cp: "2485_neut.JPG", f2: "None.jpg", ft: "none" },
        { trial_num: "p5", f1: "2276_neg.JPG", cp: "2513_neut.jpg", f2: "2276_neg.JPG", ft: "neg" },
        { trial_num: "p6", f1: "2026_neut.jpg", cp: "2870_neut.JPG", f2: "2026_neut.jpg", ft: "neu" }
    ]
